...
const Print = () => {
    ...
    if (tWindow) {
        ...
        `;
        tWindow.document.write('<html><head><title>Print it!</title><link href="https://fonts.googleapis.com/css?family=Roboto:300,400,700" rel="stylesheet"><style>' + PrintCSS + '</style></head><body>' + document.getElementById("landingPage").innerHTML + '</body></html>');
