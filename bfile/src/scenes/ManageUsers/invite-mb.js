...
class InviteMortgageBroker extends Component {
    state = {
        loading: false,
        agency_id: null,
    ...
    render() {
        ...
        return (
            <div>
                <Card type="inner" title={<Translate text={`Invite Mortgage Broker`} />} loading={loading}>
                    <div>
                        <Row gutter={16}>
                            <Col md={8} span={24}>
...
export default InviteMortgageBroker;
