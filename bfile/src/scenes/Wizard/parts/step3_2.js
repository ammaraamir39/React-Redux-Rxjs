        ...
        return (
            <div>
                <Card className="wizardCard" bordered={false} title={
                    ...
                    <Card title={<Translate text={`"Do you own any additional properties outside your primary residence (e.g. rentals, 2nd home, condo, vacant land, etc.)?"`} />} className="wizardBox" type="inner" style={{textAlign:"center"}}>
                        <RadioGroup value={wizard.secondary_home_toggle} onChange={(e) => updateField('secondary_home_toggle', e.target.value)}>
                        ...
                        <div>
                            ...
                            <Card title={<Translate text={`"What is the market value of the/these secondary property(ies)?"`} />} className="wizardBox" type="inner" style={{textAlign:"center"}}>
                                <Slider
                                    ...
                                    marks={marks}
                                    step={null}
                                    value={secondary_home_market_value}
                                    included={false}
