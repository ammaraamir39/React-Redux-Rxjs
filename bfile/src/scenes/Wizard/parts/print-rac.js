...
const Print = () => {
    ...
    if (tWindow) {
        const PrintCSS = `
            ...
            body > .ant-card-head > .ant-card-head-wrapper > .ant-card-head-title {
                font-size: 34px;
                text-align: center;
            }
        ...
        `;
        tWindow.document.write('<html><head><title>Print it!</title><link href="https://fonts.googleapis.wcom/css?family=Roboto:300,400,700" rel="stylesheet"><style>' + PrintCSS + '</style></head><body>' + document.querySelector(".wizardCardRac").innerHTML + '</body></html>');
