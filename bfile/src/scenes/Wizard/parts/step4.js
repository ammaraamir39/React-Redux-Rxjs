            ...
            <div>
                <Card className="wizardCard" bordered={false} title={
                    ...
                    <Card title={<Translate text={`"Is anyone within the household self-employed or have ownership interest in a business?"`} />} className="wizardBox" type="inner" style={{textAlign:"center"}}>
                        <RadioGroup value={wizard.business_owner_toggle} onChange={(e) => updateField('business_owner_toggle', e.target.value)}>
                    ...
                    {wizard.business_owner_toggle === "1" ? (
                        <div style={{marginBottom:20}}>
                            ...
                            <Card title={<Translate text={`"How many employees?"`} />} className="wizardBox" type="inner" style={{textAlign:"center"}}>
                                <Select value={wizard.employees_count} style={{ width: 250 }} onChange={(value) => updateField('employees_count', value)}>
                            ...
                            <Card title={<Translate text={`"What type of business is it?"`} />} className="wizardBox" type="inner" style={{textAlign:"center"}}>
                                <Select value={wizard.business_type} style={{ width: 250 }} onChange={(value) => updateField('business_type', value)}>
                    ...
                    <Card className="wizardBox center-align didYouKnowBox" type="inner">
                        ...
                        <p><Translate text={`"If your customer is a business owner, it may be a good time to have a commercial policy conversation. Also, the business assets associated with the insured could be exposed in a liability suit."`} /></p>
                    </Card>
