                            ...
                            {wizard.call_continue === true ? (
                                <div>
                                    <Card title={`You've tried 3 attempts to contact this customer. Do you want to keep trying?`} className="center-align">
                                        ...
                                        <RadioGroup value={''} onChange={this.continue.bind(this)}>
                                ...
                                <div>
                                    <RadioGroup value={wizard.call_reached_toggle} onChange={(e) => updateField('call_reached_toggle', e.target.value)}>
                                    ...
                                    {wizard.call_reached_toggle === '0' ? (
                                        <div>
                                            ...
                                            <div className="center-align">
                                                <RadioGroup value={wizard.call_not_reached_toggle} onChange={(e) => this.not_reached(e.target.value)}>
