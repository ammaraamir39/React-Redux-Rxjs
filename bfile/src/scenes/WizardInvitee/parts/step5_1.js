        ...
        return (
            <div>
                <Card className="wizardCard" bordered={false} title={
                    ...
                    <Card title={<Translate text={`"Your income and future earning potential could be exposed in a lawsuit. Our calculator defaults to a range of $25,000 - $50,000 per year, are you ok with that, or would you like to adjust it?"`} />} className="wizardBox" type="inner" style={{textAlign:"center"}}>
                        <Slider
